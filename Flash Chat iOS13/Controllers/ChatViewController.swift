...
class ChatViewController: UIViewController {
    ...
    @IBAction func logOutPressed(_ sender: UIBarButtonItem) {
      ...
      do {
        ...
        self.popUpView = PopUpWindow(title: "Error signing out: %@", text: signOutError.localizedDescription, buttontext: "OK")
        self.present(self.popUpView, animated: true, completion: nil)
      } 
